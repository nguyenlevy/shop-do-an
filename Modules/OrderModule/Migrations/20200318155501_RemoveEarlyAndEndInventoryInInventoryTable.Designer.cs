...
namespace OrderModule.Migrations
{
    ...
    [Migration("20200318155501_RemoveEarlyAndEndInventoryInInventoryTable")]
    partial class RemoveEarlyAndEndInventoryInInventoryTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderModule.Models.Inventories.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderModule.Models.OrderNotes.OrderNote", b =>
                {
                    b.HasOne("OrderModule.Models.Orders.Order", "Order")
                        .WithOne("OrderNote")
                        .HasForeignKey("OrderModule.Models.OrderNotes.OrderNote", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
