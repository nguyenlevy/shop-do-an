...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-product-product-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsProductProductMenuFilterProductMenuFilterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<p>product-menu-filter works!</p>\r\n";
    /***/
  },
  ...
  /***/
  function srcAppComponentsProductProductMenuFilterProductMenuFilterComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsProductProductMenuFilterProductMenuFilterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductMenuFilterComponent", function () {
    ...
    var ProductMenuFilterComponent = /*#__PURE__*/function () {
      function ProductMenuFilterComponent() {
        _classCallCheck(this, ProductMenuFilterComponent);
      }

      _createClass(ProductMenuFilterComponent, [{
        key: "ngOnInit",
    ...
    ProductMenuFilterComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'app-product-menu-filter',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./product-menu-filter.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/product/product-menu-filter/product-menu-filter.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./product-menu-filter.component.scss */
      "./src/app/components/product/product-menu-filter/product-menu-filter.component.scss"))["default"]]
    }), __metadata("design:paramtypes", [])], ProductMenuFilterComponent);
    /***/
  },
  ...
  function srcAppComponentsProductProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductComponent = /*#__PURE__*/function () {
      function ProductComponent(appSettings, appService, mediaObserver, platformId) {
        var _this = this;
      ...
      _createClass(ProductComponent, [{
        ...
        value: function getProperties() {
          ...
          this.appService.getProperties().subscribe(function (data) {
            ...
            if (result.data.length == 0) {
              ...
              _this2.pagination = new src_app_app_models__WEBPACK_IMPORTED_MODULE_2__["Pagination"](1, _this2.count, null, 2, 0, 0);
        ...
        value: function searchChanged(event) {
          ...
          event.valueChanges.subscribe(function () {
            ...
            _this3.searchFields = event.value;
            setTimeout(function () {
              _this3.removedSearchField = null;
            });

            if (!_this3.settings.searchOnBtnClick) {
              _this3.properties.length = 0;
            }
          });
          event.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["distinctUntilChanged"])()).subscribe(function () {
            if (!_this3.settings.searchOnBtnClick) {
              _this3.getProperties();
            }
          });
        }
      }, {
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('sidenav'), __metadata("design:type", Object)], ProductComponent.prototype, "sidenav", void 0);

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginator"]), __metadata("design:type", _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginator"])], ProductComponent.prototype, "paginator", void 0);
    ...
    }), __param(3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_0__["PLATFORM_ID"])), __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"], src_app_app_service__WEBPACK_IMPORTED_MODULE_4__["AppService"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["MediaObserver"], Object])], ProductComponent);
    /***/
  },
  ...
  function srcAppComponentsProductProductModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _product_menu_filter_product_menu_filter_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./product-menu-filter/product-menu-filter.component */
    "./src/app/components/product/product-menu-filter/product-menu-filter.component.ts");
    ...
    ProductModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
